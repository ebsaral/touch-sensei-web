    ...
    if (locale == "tr") {
      return (
        <div className="notes text-justify font-[family-name:var(--font-geist-mono)] whitespace-pre-line">
            ...
            <p className="mb-6 text-left text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-white">Touch Sensei, ilk kez 2014 yılında, <a href="http://hipolabs.com">Hipo</a>'daki bir hackathon için aklıma gelen basit bir oyun fikriydi. Oyunun sıkıcı olduğunu düşündüğüm için oyunu geliştirmeye devam etmedim. Mobil uygulamalara yönelik tecrübemi yansıtmaya vaktim olduğu için oyunun orijinal versiyonunu biraz geliştirerek yayına almaya karar verdim. Böylece birkaç hafta Unity'de uygulamayı geliştirerek, 1 Ekim 2024’te Touch Sensei’nin ilk sürümü App Store’da yayına aldım. Google Play Store sürümü ise gecikecek gibi duruyor.</p>
    ...
    if(locale == "de") {
      return (
        <div className="notes text-justify font-[family-name:var(--font-geist-mono)] whitespace-pre-line">
            ...
            <p className="mb-6 text-left text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-white">Touch Sensei war eine einfache Spielidee, die mir 2014 während eines Hackathons bei <a href="http://hipolabs.com">Hipo</a> kam. Ich beschloss, die Entwicklung einzustellen, weil ich das Spiel langweilig fand. Da ich Zeit hatte, über meine Erfahrungen mit mobilen Apps nachzudenken, beschloss ich, die Originalversion zu erweitern und zu veröffentlichen. Nach einigen Wochen der App-Entwicklung in Unity veröffentlichte ich die erste Version von Touch Sensei am 1. Oktober 2024 im App Store. Die Veröffentlichung im Google Play Store scheint sich zu verzögern.</p>
