    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      ...
      <div className="row-start-3 flex gap-6 flex-wrap items-center justify-center">
        ...
        <Image
          ...
          src="/images/touch-sensei-preview.png"
          alt="Touch Sensei preview image"
          width={700}
          height={200}
          priority
        />

        <div className="row-start-3 flex gap-6 mt-10 mb-10 text-4xl text-center font-bold font-[family-name:var(--font-geist-mono)] whitespace-pre-line">
        <h1>{t('Link.DetailsPage.name')}</h1>
        </div>
